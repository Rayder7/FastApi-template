...
Создаем виртуальное окружение и необходимо установить pip-tools: pip install pip-tools
Необходимо установить зависимости: pip-sync
В папке src необходимо мигрировать модели в БД: alembic upgrade head
